---
title: "Official Asus XG-C100C V1 firmware update available"
...
<Aside>
  <h2>October 2025 note</h2>
  <p>
    This post was written about the original version of the Asus XG-C100C. Since
    this post was published, Asus released V2 and V3 revisions of the card.
    These use a newer chipset than the original version of the card, and the
    info below about updating firmware does not apply to these cards.
  </p>
</Aside>
}
