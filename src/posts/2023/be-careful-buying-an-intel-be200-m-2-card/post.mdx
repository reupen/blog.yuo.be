...
tags:
  - hardware
excerpt: |-
  I nearly bought one. Then I noticed that it wouldn’t fit in my laptop.
---
...
This post is quite popular for some reason, so it’s probably worth pointing out
that the BE200 does not use CNVi. At some point Intel also made the
[BE200 product brief document](https://www.intel.com/content/www/us/en/content-details/761674/intel-wi-fi-7-be200-gale-peak-2-product-brief.html?DocID=761674)
public.

Alas, neither of those two points help with the compatibility problems the BE200
has with AMD systems.
