...
tags:
  ...
  - win32
excerpt: |-
  I suppose clicking a mouse button can be noisy.
---
...
or collapse icon for an item and hold Shift, scrolling the mouse wheel down will
collapse the item, and scrolling the mouse wheel up will expand it (which is
backwards if you ask me, but never mind).
