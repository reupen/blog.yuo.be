...
image:
  src: ./excuse-me.avif
  alt:
    A screenshot of the screen showing dialogue between two leaders, with Xerxes
    saying ‘Indeed. Now if you will excuse me’
tags:
  - gaming
excerpt: |-
...
<CaptionedImage
  ...
  caption="So much scrolling in that list"
/>
...
<CaptionedImage
  ...
  caption="I’m starting to think Goldilocks was misunderstood"
/>
...
<CaptionedImage
  ...
  caption="That’s not how spacing is meant to work, Firaxis"
/>
...
<CaptionedImage
  ...
  caption="This screen really needs a bit of design thought into the layout"
/>

For some reason[^1], someone’s fiddled with the character spacing of the second
and third paragraphs, while managing to leave the first paragraph alone. Compare
the ‘the’ from the first and second paragraphs, for example:
...
<CaptionedImage
  ...
  caption="Did anyone put any thought into that ‘Turns remaining’ text?"
/>
...
<CaptionedImage
  ...
  caption="Weird alignment and spacing problems are scattered throughout the game"
/>
...
on the floating name banner above the tile was doing nothing at the time).
...
<CaptionedImage
  ...
  caption="And, of course, the continue button text is misaligned"
/>
...
[^1]:
    I assume it’s related to the headings in capitals at the start of the second
    and third paragraphs. Alas, that wasn’t really the point.
