...
I was debugging an odd-looking Columns UI crash from a Windows 8.1 device. The
crash was odd because it looked like something that should be impossible. In
fact, however, it was easily reproducible.

The reason became obvious when examining the DirectWrite headers. Compare the
start of the declaration of the
