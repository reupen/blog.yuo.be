...
200×200px crop. Here’s that crop scaled to 200% with nearest neighbour
interpolation, along with greyscale versions of the red, green and blue
channels:
...
Here are some 400px by 225px crops, scaled to 200%, to visualise the main steps
so far.
