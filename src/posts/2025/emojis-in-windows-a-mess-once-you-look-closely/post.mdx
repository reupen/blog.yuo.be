...
>
  Look closely, and you’ll also see that the red heart in the tab is not the
  same as the one in the typing area
</CaptionedImage>
...
>
  Some features in Window 11 use React Native and WebViews, causing more
  inconsistency
</CaptionedImage>
