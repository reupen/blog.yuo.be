...
tags:
  - web
excerpt: |-
  I’ve turned the blog into a static site and given it a facelift.
---
...
- having had some upgrade failures that were difficult to recover from
...
dream happen. And just over a week later, you’re looking at the result.
...
stored, from Markdown to various iterations of its ‘cards’.
...
As usual,
[the site is open source for curious eyes](https://github.com/reupen/blog.yuo.be).
